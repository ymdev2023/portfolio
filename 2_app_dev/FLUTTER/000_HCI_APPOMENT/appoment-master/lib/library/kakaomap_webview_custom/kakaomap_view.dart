import 'dart:convert';
import 'package:appoment/library/kakaomap_webview_custom/kakao_figure.dart';
import 'package:appoment/library/kakaomap_webview_custom/kakao_latlng.dart';
import 'package:appoment/library/kakaomap_webview_custom/kakaomap_type.dart';
...
class KakaoMapView extends StatelessWidget {
  ...
  final void Function(KakaoLatLng)? onMapClicked;
  ...
  final void Function()? onMapLoadFinished;
    ...
    channels.add(JavascriptChannel(
        ...
        onMessageReceived: (message) {
          if (onMapClicked != null) {
            final latLng = jsonDecode(message.message);
            final kakaoLatLng = KakaoLatLng(lat: latLng["lat"], lng: latLng["lng"]);
            onMapClicked!(kakaoLatLng);
          }
        }));
